   ...
   return (
      <div className={styles.newTodo}>
         <div className={styles.content}>
            ...
            <Step step={step} />
            {
               step === 1 ? <StepFirst incrementStep={incrementStep} /> : <StepTwo decrementStep={decrementStep} />
            }
         </div>
      </div>
   );
...
const StepFirst: FC<StepFirstProps> = ({ incrementStep }) => {
   ...
   return (
      <div className={styles.blocks}>
         <ToDoItem Click={Click} />
         <ToDoItem Click={Click} /> <ToDoItem Click={Click} />
         <ToDoItem Click={Click} /> <ToDoItem Click={Click} />
         <ToDoItem Click={Click} /> <ToDoItem Click={Click} />
      </div>
   )
...
const StepTwo: FC<StepTwoProps> = ({ decrementStep }) => {
   const Click = () => {
      decrementStep();
   }
